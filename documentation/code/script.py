...
tickerList = ['SAB.MC', 'SAN.MC', 'AENA.MC', 'ELE.MC', 'NTGY.MC', 'PHM.MC', 'ENG.MC', 'GRF.MC', 'CABK.MC',
              'ITX.MC', 'BKT.MC', 'VIS.MC', 'REE.MC', 'CLNX.MC', 'BBVA.MC', 'MRL.MC', 'FER.MC', 'MTS.MC',
              'MAP.MC', 'COL.MC', 'ACX.MC', 'ACS.MC', 'IBE.MC', 'FDR.MC', 'TEF.MC', 'ANA.MC', 'IAG.MC',
              'AMS.MC', 'SGRE.MC', 'MEL.MC', 'ALM.MC', 'CIE.MC', 'IDR.MC', 'ROVI.MC']
minimo = 4
maximo = 4
...
for i in range (len(dateList)):
    ...
    for k in range(minimo,maximo+1):
        ...
        [resultA,result] = executeController.executeBest(tickerList,dateStart,dateEnd,money,k)
